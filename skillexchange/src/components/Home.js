    ...
    return (
        <section id="home" class="hero">
            <div class="hero-inner">
                <h1>Разменяйте услуги лесно — учете, предавайте, и печелете</h1>
                <p class="lead">ServiceExchange е място, където хората предлагат и търсят услуги/уроци/сътрудничество.
